...
public class RDFsCrawlerImpl implements RDFsCrawler {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("  Version: " + version);
		 ...
		 args = new String[4];
		 args[0] = "-ac";
		 args[1] = "http://metadb.riken.jp/sparql";
		 args[2] = "RIKENMetaDatabase";
		 args[3] = "/home/kobayashi7/";

		// String endPURI = "http://beta.sparql.uniprot.org/sparql";
		...
		// String crawlName = "allie";

		// String endPURI =
		// "http://www.ebi.ac.uk/rdf/services/chembl/sparql";
		// String crawlName = "chembl";

		// String endPURI =
		// "http://www.ebi.ac.uk/rdf/services/reactome/sparql";
		// String crawlName = "reactome";

		// String endPURI =
		// "http://www.ebi.ac.uk/rdf/services/biomodels/sparql";
		// String crawlName = "biomodels";

		// String endPURI =
		// "http://www.ebi.ac.uk/rdf/services/biosamples/sparql";
		// String crawlName = "biosamples";
		// String endPURI =

		// "http://www.ebi.ac.uk/rdf/services/atlas/sparql";
		// String crawlName = "atlas";

		// String endPURI = "http://sparql.openlifedata.org/";
		// String crawlName = "openlifedata";

		// String endPURI = "http://oip.rothamsted.ac.uk/sparql";

		// String endPURI = "http://172.27.18.85:8890/sparql";

		// String endPURI = "http://dbpedia.dbcls.jp/sparql";
		// String endPURI = "http://172.27.18.93:8890/sparql";
		// String crawlName = "dbpedia";

//		 String endPURI = "http://metadb.riken.jp/sparql";
//		 String crawlName = "metadb";

		// String endPURI = "http://dba-rdf.biosciencedbc.jp/sparql";
		// String crawlName = "dbardf";

		// String endPURI = "http://172.27.19.25:8890/sparql";
		// String crawlName = "dbpedia";

		// String endPURI = "http://172.27.19.25:8890/sparql";
		// String crawlName = "dbpedia";

		// String endPURI = "http://lod.hozo.jp/repositories/DbArcTest";
		// String crawlName = "dbArcTest";

		// String endPURI = "http://sparql.openlifedata.org/";
		// String crawlName = "openLifeData2";
